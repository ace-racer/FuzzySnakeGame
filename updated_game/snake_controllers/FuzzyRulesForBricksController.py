...
###############################################################################################
    def mf_pm_left(self):
        ...
        self.rule19 = ctrl.Rule(self.collison_brick_ang_2['90'], self.next_move_pm_left['up'])
        self.rule20 = ctrl.Rule(self.collison_brick_ang_2['-90'], self.next_move_pm_left['down'])
